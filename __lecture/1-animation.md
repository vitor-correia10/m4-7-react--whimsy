...
<img src={stripeError} style={{ maxWidth: '100%', maxHeight: '70vh' }} />

---

import stripeSendingSms from './assets/stripe-sending-sms.gif';

<img src={stripeSendingSms} style={{ maxWidth: '100%', maxHeight: '70vh' }} />
...
<img src={rainbowButtonSrc} style={{ maxWidth: '100%', maxHeight: '70vh' }} />
